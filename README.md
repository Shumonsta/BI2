...
[View the live project here.](https://shumonsta.github.io/BI2/)
...
-   ### User stories
    ...
    -   #### Returning Visitor Goals
        ...
        1. As a Returning Visitor, I want to find information about participating.
...
-   ### Design
    -   #### Colour Scheme
        -   The two main colours used are Code Insititue green, and white.
    -   #### Imagery
        -   Imagery is important. The large, background hero image is designed to be striking and catch the user's attention. It also has a modern, energetic aesthetic.

*   ### Wireframes

    -   Wireframe - [View](https://github.com/Shumonsta/BI2/blob/Richard/assets/documentation/Readofamily.pdf)
...
-   #### First Time Visitor Goals
    ...
    2. As a First Time Visitor, I want to be able to easily be able to navigate throughout the site to find content.
        ...
        3. On the Contact Us Page, there is a form to be submitted.
